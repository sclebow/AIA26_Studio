...
def load_design_settings() -> DesignSettings:
    ...
    max_iterations_value = os.environ.get("MAX_ITERATIONS", "10")
    max_design_iterations_value = os.environ.get("MAX_DESIGN_ITERATIONS", "5")
    ...
    return DesignSettings(
        ...
        max_design_iterations=int(max_design_iterations_value),
    )
