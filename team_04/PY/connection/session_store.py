...
Each session holds:
  - state          : the latest AgentState snapshot (from agent.state)
  - history        : list of chat messages (role, content, message_id, timestamp, tags)
  - decision_graph : a DecisionGraph tracking the design process as a DAG
  - created_at     : ISO timestamp string

Thread-safety: a dict protected by an asyncio.Lock. Swap for Redis/DB in prod.
"""
