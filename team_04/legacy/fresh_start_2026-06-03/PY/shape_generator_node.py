...
class ShapeGenerator:
    ...
    def genes_to_parameters(self, genes: dict[str, Any] | ShapeGenes) -> ShapeParameters:
        ...
        return ShapeParameters(
            ...
            segment_spacing=template.get("segment_spacing", 8.0) or 8.0,
            connector=template.get("connector", False),
        )
    ...
    def generate_shape(self, params: ShapeParameters) -> ShapeOutput:
        ...
        if shape_type in [ShapeType.RECTANGLE.value.lower(), "rectangular"]:
            ...
            return self.generate_i_shape(
                ...
                segment_spacing=params.segment_spacing if params.segment_spacing is not None else 8.0,
                height=params.height,
                base_point=params.base_point,
                rotation_angle=params.rotation_angle,
...
def create_shape_generator_node(
    ...
    def shape_generator_node(state: dict[str, Any], /) -> dict[str, Any]:
        ...
        if not shape_request and isinstance(state.get("design_state"), dict):
            shape_request = state["design_state"].get("shape_request", {})
        ...
        try:
            ...
            params = ShapeParameters(
                ...
                segment_spacing=shape_request.get("segment_spacing", 8.0),
                connector=shape_request.get("connector", False),
